...
typedef enum _nvme_config_xcoder_config_instance_subtype
{
  ...
  nvme_config_xcoder_config_set_dec_packet_size = 0x000b
 ...
 * \return
 *******************************************************************************/
int32_t ni_nvme_send_admin_cmd(ni_nvme_admin_opcode_t opcode, ni_device_handle_t fd, 
	                           ni_nvme_command_t *p_ni_nvme_cmd, uint32_t data_len, void *data, uint32_t *pResult);
 ...
 * \return
 *******************************************************************************/
int32_t ni_nvme_send_io_cmd_thru_admin_queue(ni_nvme_admin_opcode_t opcode, ni_device_handle_t fd, 
...
ni_retcode_t ni_nvme_check_error_code(int rc, ni_nvme_admin_opcode_t opcode,
                                      uint32_t xcoder_type, uint32_t hw_id, int32_t* inst_id);
...
#define HIGH_OFFSET_IN_4K(sid,instance)     ((((sid & 0x7FUL)<<1)|(instance))<<NI_INSTANCE_TYPE_OFFSET)  // 1024MB
...
//identify
#define IDENTIFY_DEVICE_R               HIGH_OFFSET_IN_4K(0,0) + CTL_OFFSET_IN_4K(GAP(0xD7), 1, 0)
