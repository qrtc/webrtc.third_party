...
/* QueryPerformanceCounter will be more accurate for us testing */
uint64_t ni_gettimediff(uint64_t t1, uint64_t t2)
{
    LARGE_INTEGER Frequency;
    QueryPerformanceFrequency(&Frequency);
    return ((t2 - t1)*1000000/Frequency.QuadPart);
}

void ni_gettime(uint64_t *t)
{
    LARGE_INTEGER Count;
